<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ListaCliente.aspx.cs" Inherits="Formulario.Web.ListaCliente" %>
            ...
            <div class="container">
                ...
                <div class="navbar-collapse collapse d-sm-inline-flex flex-sm-row-reverse">
                    <ul class="navbar-nav flex-grow-1">
                        ...
                        <li class="nav-item">
                            <a class="nav-link text-info" asp-area="" asp-page="ListaCliente.aspx" href="ListaCliente.aspx">Lista de Clientes</a>
                        </li>
                        <li class="nav-item">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-12 text-center my-2">
                            <h2 class="display-6">Lista de Clientes</h2>
